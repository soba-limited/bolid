...
//*************************************************************
// Rule
//1.  use App\Http\Requests\LPostUserValidation; //Add Controller
//2.  public function store( LPostUserValidation $request ){ //example
//*************************************************************

class LPostUserValidation extends FormRequest
{
    /**
